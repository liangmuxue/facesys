...
import com.ss.isc.data.resource.client.IDeviceService;
        ...
        try {
            ...
            if (villages == null || villages.length == 0) {
                ...
                if (null != villages && villages.length > 0) {
                    List<com.ss.isc.data.collect.common.model.Camera> cameras = this.caputerService.getAllCamera(villages);
                    List<String> list = new ArrayList<>();
                    for (com.ss.isc.data.collect.common.model.Camera camera : cameras) {
