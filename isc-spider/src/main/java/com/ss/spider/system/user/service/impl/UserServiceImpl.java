...
import com.ss.spider.system.role.service.impl.RoleResourceServiceImpl;
...
**/
@Service("userService")
public class UserServiceImpl extends AbstractCWServiceImpl<User> implements UserService<User> {
