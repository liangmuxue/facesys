...
public class OrgQuery extends Pagination {
    ...
    @NotBlank(message = "{org.ids.empty}", groups = {com.ss.valide.APIGetsGroup.class})
    ...
    @Range(min = 0L, max = 1L, groups = {com.ss.valide.APIListGroup.class}, message = "{data.Type.value.error}")
