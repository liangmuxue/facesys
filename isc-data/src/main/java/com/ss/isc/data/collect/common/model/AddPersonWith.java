...
public class AddPersonWith
{
  ...
  public int getSuspectState() { return this.suspectState; }


  
  public void setSuspectState(int suspectState) { this.suspectState = suspectState; }


  
  public String getAddPersonDetId() { return this.addPersonDetId; }


  
  public void setAddPersonDetId(String addPersonDetId) { this.addPersonDetId = addPersonDetId; }
