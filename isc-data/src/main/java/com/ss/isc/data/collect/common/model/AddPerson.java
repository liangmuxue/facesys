...
public class AddPerson {
  ...
  public AddPerson(String id, Integer state) {
    this.id = id;
    this.state = state;
  }
  ...
  public String getCreatedTimeStr() { return CommonConstant.DATE_PATTERN.format(getCreatedTime()); }
  ...
  public String getUpdateTimeStr() { return CommonConstant.DATE_PATTERN.format(getUpdateTime()); }
  ...
  public List<AddPersonDetail> getDetail() { return this.detail; }

  
  public void setDetail(List<AddPersonDetail> detail) {
    Collections.sort(detail, new Comparator<AddPersonDetail>()
        {
          public int compare(AddPersonDetail o1, AddPersonDetail o2) {
