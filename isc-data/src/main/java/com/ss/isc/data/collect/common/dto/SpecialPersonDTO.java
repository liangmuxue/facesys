...
public class SpecialPersonDTO
{
  ...
  public String toString() { return "SpecialPersonDTO [id=" + this.id + ", peopleId=" + this.peopleId + ", peopleName=" + this.peopleName + ", villageCode=" + this.villageCode + ", capturePath=" + this.capturePath + ", panoramaPath=" + this.panoramaPath + ", credentialNo=" + this.credentialNo + ", residenceAddress=" + this.residenceAddress + ", idCardPic=" + this.idCardPic + ", recordId=" + this.recordId + ", state=" + this.state + ", specialType=" + this.specialType + ", days=" + this.days + ", remark=" + this.remark + ", leaveTime=" + this.leaveTime + ", createdTime=" + this.createdTime + ", updateTime=" + this.updateTime + ", rowNum=" + this.rowNum + ", lastCaptureTime=" + this.lastCaptureTime + ", facePitch=" + this.facePitch + ", faceYaw=" + this.faceYaw + ", faceRoll=" + this.faceRoll + ", facex=" + this.facex + ", facey=" + this.facey + ", faceWidth=" + this.faceWidth + ", faceHeight=" + this.faceHeight + "]"; }
}
