...
public class VehicleVO implements Serializable {
    ...
    @NotNull(message = "{VehicleVO.id.empty}", groups = {com.ss.valide.APIEditGroup.class, com.ss.valide.APIDeltGroup.class})
    private Integer id;
    @NotBlank(message = "{VehicleVO.villageCode.empty}", groups = {com.ss.valide.APIAddGroup.class, com.ss.valide.APIEditGroup.class})
    private String villageCode;
    @NotBlank(message = "{VehicleVO.plateNo.empty}", groups = {com.ss.valide.APIAddGroup.class, com.ss.valide.APIEditGroup.class})
    private String plateNo;
    private Integer plateColor;
    @NotNull(message = "{VehicleVO.plateType.empty}", groups = {com.ss.valide.APIAddGroup.class, com.ss.valide.APIEditGroup.class})
    private Integer plateType;
    @NotNull(message = "{VehicleVO.carType.empty}", groups = {com.ss.valide.APIAddGroup.class, com.ss.valide.APIEditGroup.class})
    private Integer carType;
    @NotNull(message = "{VehicleVO.carColor.empty}", groups = {com.ss.valide.APIAddGroup.class, com.ss.valide.APIEditGroup.class})
