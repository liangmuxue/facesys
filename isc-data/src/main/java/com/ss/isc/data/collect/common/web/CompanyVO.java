  ...
  extends BaseQueryEntity
{
  ...
  @NotNull(message = "{company.id.empty}", groups = {com.ss.valide.APIPageGroup.class, com.ss.valide.APIGetsGroup.class, com.ss.valide.APIListGroup.class, com.ss.valide.APIDeltGroup.class})
  private Integer id;
