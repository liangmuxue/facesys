...
import com.ss.isc.data.collect.common.dto.AddPersonDTO;
import com.ss.isc.data.collect.common.dto.AddPersonDetailVO;
...
import com.ss.isc.data.collect.common.web.AddPersonQuery;
...
@Repository
@Mapper
public interface AddPersonMapper extends CWMapper<AddPerson> {
