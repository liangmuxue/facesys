...
import com.ss.isc.data.resource.common.model.Facedb;
...
import com.ss.isc.data.resource.common.web.PeopleImageVO;
    ...
    public int insertVillage(Village village) throws Exception {
        ...
        if (result > 0) {
            ...
            if (StringUtils.checkSuccess(jsonObject)) {
                ...
                // 新增社区人像库数据
                com.ss.isc.data.collect.common.model.Facedb ssFacedb = new com.ss.isc.data.collect.common.model.Facedb();
