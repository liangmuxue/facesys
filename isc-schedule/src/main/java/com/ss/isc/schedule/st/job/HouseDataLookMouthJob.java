 ...
 **/
public class HouseDataLookMouthJob implements SimpleJob {

    public static final Log LOG = LogFactory.getLog(HouseDataLookMouthJob.class);
    ...
    public void execute(ShardingContext shardingContext) {
        ...
        for(int mouthNum = 1;mouthNum <= n;mouthNum++){
            //本月数据
            this.idataLookService.selthisMouthHouse(mouthNum);
        }
    }
}
