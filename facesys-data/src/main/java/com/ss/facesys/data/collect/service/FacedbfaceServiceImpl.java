...
//        duplicateCheck(facedbFace);
        ...
        // 新增汇聚平台数据
        FacedbfaceDTO facedbfaceDTO = insertVplatFacedbface(facedbFace);
        // 更新人像系统数据
...
//        duplicateCheck(facedbFace);
     ...
     * @return
     */
    private FacedbfaceDTO insertVplatFacedbface(FacedbFace facedbFace) throws ServiceException {
