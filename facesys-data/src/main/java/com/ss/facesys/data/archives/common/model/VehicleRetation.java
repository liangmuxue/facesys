...
@Table(name = "cw_vehicle_retention")
public class VehicleRetation implements Serializable {
    private static final long serialVersionUID = -4167322971871134357L;
    private String id;
    ...
    public VehicleRetation() {
    }


    public VehicleRetation(String villageCode, Integer status) {
        this.villageCode = villageCode;
        this.status = status;
    }
