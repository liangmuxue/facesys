...
public class FrequencyNightPerson {
  private String id;
  ...
  private List<FrequencyNightPersonDetail> detail;
  ...
  public FrequencyNightPerson(String id, Integer state) {
    this.id = id;
    this.state = state;
  }
  ...
  public List<FrequencyNightPersonDetail> getDetail() { return this.detail; }

  
  public void setDetail(List<FrequencyNightPersonDetail> detail) {
    Collections.sort(detail, new Comparator<FrequencyNightPersonDetail>()
        {
          public int compare(FrequencyNightPersonDetail o1, FrequencyNightPersonDetail o2) {
