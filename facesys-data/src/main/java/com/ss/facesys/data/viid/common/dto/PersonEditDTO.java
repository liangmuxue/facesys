...
import com.ss.facesys.data.viid.common.dto.ext.PersonExt;
...
public class PersonEditDTO {
    ...
    public PersonEditDTO(List<PersonExt> personExts, String appId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PersonEditDTO)) return false;
        PersonEditDTO other = (PersonEditDTO) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof PersonEditDTO;
    }
    ...
    public String toString() {
        return "PersonEditDTO(personExts=" + getPersonExts() + ", appId=" + getAppId() + ")";
    }
