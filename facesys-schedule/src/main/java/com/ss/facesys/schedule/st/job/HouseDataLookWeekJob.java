 ...
 **/
public class HouseDataLookWeekJob implements SimpleJob {

    public static final Log LOG = LogFactory.getLog(HouseDataLookWeekJob.class);
    ...
    public void execute(ShardingContext shardingContext) {
        ...
        for(int weekNum=1;weekNum <= n;weekNum++){
            //本月数据
            this.idataLookService.selThisWeekHouse(weekNum);
        }
    }
}
