 ...
 **/
public class HouseDataLookDayJob implements SimpleJob {

    public static final Log LOG = LogFactory.getLog(HouseDataLookDayJob.class);
    ...
    public void execute(ShardingContext shardingContext) {
        ...
        for(int dayNum=1;dayNum <= n;dayNum++){
            //每天数据
            this.idataLookService.selThisThirtyDayHouse(dayNum);
        }
